...
if ($_POST) {
    ...
    if (empty($errors)) {
        try {
            ...
            saveTourPickupTimes((int) $tour_id, $pickupTimesPost, $pickupUseDefaultsPost);
    ...
    if (!empty($errors)) {
        ...
        $pickupUseDefaults = !empty($_POST['pickup_use_defaults']);
        $selectedPickupTimes = [];
        if (!$pickupUseDefaults && is_array($_POST['pickup_times'] ?? null)) {
